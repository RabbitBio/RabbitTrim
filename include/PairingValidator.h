...
namespace rabbit{
    class PairingValidator{
        private:
            ...
            std::string casava_13 = "(.* )?([^:]+:[0-9]+:[0-9]+:[0-9]+:[0-9]+#[A-Z0-9]+).*";
            std::string casava_18 = "(.* )?([^:]+:[0-9]+:[A-Z0-9]+:[0-9]+:[0-9]+:[0-9]+:[0-9]+).*";

        public:
            PairingValidator(rabbit::Logger &logger_):logger(logger_), fqNamePattern1(casava_13, "$2"), fqNamePattern2(casava_18, "$2"){
