...
void find_seed(char* seq,int len, const int16_t** seed_pos_1, const int16_t** seed_pos_2, int p1, int p2,
...
int main(){
    ...
    for (int i = 0; i < (1 << 20); i++){
        ...
        start = getTime();
        find_seed(seq,len,seed_pos_1, seed_pos_2, 0, 0, 'C','T','G','T','C','T');
