...
namespace rabbit
{
   class IlluminaPrefixPair{
        public:
            ...
            IlluminaPrefixPair(std::string prefix1_, std::string prefix2_, rabbit::Logger& logger, int phred_, int minPrefix_, int seedMaxMiss, int minPalindromeLikelihood_, bool palindromeKeepBoth_);
            ...
            int palindromeReadCompare(Reference& rec1, Reference& rec2);
        private:
